/**
 * Thesis State Engine V2.3
 * 
 * Extends V2 Thesis State Engine:
 * - Preserves strict debounce / hysteresis (2 ticks)
 * - Preserves absolute EMERGENCY override (corrupted data, <5 SOL liquidity, catastrophic distribution >= 85)
 * - Emits detailed thesis telemetry for adaptive profit harvesting
 */

export class ThesisStateEngineV2_3 {
    constructor(options = {}) {
    ...
    _evaluateRaw(state, position, currentTime) {
        ...
        // 1. EMERGENCY checks (Hard Safety priority)
